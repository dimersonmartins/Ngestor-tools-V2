...
namespace BotWanet03FieldService.Http
{
    class ExtrairOrdensServicos
    {
        ...
        public async Task<string> GetOrders()
        {
            try
            {
                string url = "http://wanet03.netservicos.com.br/net3/TD/TDMaster.asp?InstID=1&UID=" + Config.sesseion;
                ...
                client.DefaultRequestHeaders.Add("Referer", "http://wanet03.netservicos.com.br/net3/TD/TDMain1.asp?InstID=1");
        ...
        public async Task<string> GetOrderByWo(string WorkOrderUID)
        {
            try
            {
                string url = "http://wanet03.netservicos.com.br/net3/TD/TDMaster.asp?InstID=1&UID=" + Config.sesseion + "&Function=GetAllInformation&FilterWorkOrder=1|" + WorkOrderUID;
                HttpClient client = new HttpClient(new HttpClientHandler { UseCookies = false, AutomaticDecompression = DecompressionMethods.GZip | DecompressionMethods.Deflate });
                client.Timeout = TimeSpan.FromHours(2);
