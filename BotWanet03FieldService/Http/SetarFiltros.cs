...
namespace BotWanet03FieldService.Http
{
    class SetarFiltros
    {
        public async Task<string> configurarFiltros()
        {
            ...
            string url = "http://wanet03.netservicos.com.br/net3/TD/TDMaster.asp?InstID=1&UID=" + Config.sesseion + "&Function=GetSessionInfo";
            ...
            client.DefaultRequestHeaders.Add("Referer", "wanet03.netservicos.com.br");
